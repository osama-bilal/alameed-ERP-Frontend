...
class ReportsPage extends StatelessWidget {
  ...
  final List<Report> reports = List.generate(
    5,
    (i) => Report(id: i, startDate: DateTime.now(), endDate: DateTime.now().add(Duration(days: 7)), reportType: "daily", totalSales: "1000", totalDeposits: "500", totalExpenses: "300", totalWithdraws: "200", netProfit: "500", totalInvoices: 10, totalProductsSold: 50)
