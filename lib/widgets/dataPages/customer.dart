            ...
            child: Row(
              ...
              children: [
                ...
                PermissionGuard(
                  ...
                  child: MySearchAnchor<Customer>(searchIn: customers),
                ),
                //   SearchAnchor(
        ...
        actions: <Widget>[
          ...
          ElevatedButton(
            ...
            onPressed: () {
              ...
              customer.email = emailController.text.isNotEmpty ? emailController.text : null;
              customer.address = addressController.text.isNotEmpty ? addressController.text : null;
